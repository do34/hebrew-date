...
const gWeekday = ["Sun", "Mon", "Tues", "Wednes", "Thurs", "Fri", "Sat"]
    , gMonth = ["January", "February", "March", "April", "May", "June", "July", "August","September","October","November","December"]
    , hMonth = ["Tishri", "Heshvan", "Kislev", "Tevet", "Shevat", "Adar I", "Adar II", "Nisan", "Iyyar", "Sivan", "Tammuz", "Av", "Elul", "Adar"]
    , hMonthHe = "תשרי,חשוון,כסלו,טבת,שבט,אדר א',אדר ב',ניסן,אייר,סיוון,תמוז,אב,אלול,אדר".split(',')
...
module.exports = function (inputDateOrYear, inputMonth, inputDate) {
    ...
    let monthNameFixed = hMonth[hebrewMonth - 1];
    let monthNameFixedHe = hMonthHe[hebrewMonth - 1];
    if (oneAndOnlyAdar && hebrewMonth==6) {
      monthNameFixed =  hMonth[13];
      monthNameFixedHe =  hMonthHe[13];
    }
    ...
    return {
      ...
      , month: hebrewMonth
      , date: hebrewDate
      , month_name: monthNameFixed
      , month_name_he: monthNameFixedHe
    };
};
